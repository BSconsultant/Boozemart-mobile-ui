...
function bottomTabsVariant3() {
    ...
    return (
        <Tab.Navigator tabBar={props => <Variant3BottomTabBar {...props} style={{display: contextData.stateData.common.isTabBarVisible?"flex":"none"}} />}>
            <Tab.Screen name={Routes.HOME_STACK} component={HomeStack}/>
            <Tab.Screen name={Routes.FAVOURITES_STACK} component={FavouritesStack}/>
            <Tab.Screen name={Routes.GIFT_STACK} component={GiftStack}/>
